...
if(isset($_POST['em'], $_POST['pw'])) {
  ...
  $senha = hash('sha256', $_POST['pw']);
	...
	$sql = "SELECT * FROM usuarios WHERE nm_email = '".$_POST['em']."' AND ds_senha = '".$senha."'";
  ...
  <body class="text-center">
    ...
    <div class="container">
      <form class="form-signin" method="post">
        <h1 class="h3 mb-3 font-weight-normal" style="color: white;">Showes</h1>
        <h6 class="h6 mb-3 font-weight-normal" style="color: white;">A Loja de Tênis que é um <strong>SHOW!</strong></h6>
        ...
        <a href="criar_usuario.php" id="r"><p>Registre-se</p></a>
